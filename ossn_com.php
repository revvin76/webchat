...
define('__OSSN_WEB_CHAT__', ossn_route()->com . 'WebChat/');

//this function is used to initilize ossn
function ossn_web_chat() {
...
ossn_register_callback('ossn', 'init', 'ossn_web_chat');
